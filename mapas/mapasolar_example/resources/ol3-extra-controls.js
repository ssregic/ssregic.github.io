    ...
    if (name){
        ...
        if (!(layer instanceof ol.layer.Group)){
            if (layer.get("type") != "base" && this.showZoomTo){
                div += "<a title='Zoom a la Capa' href='#' style='padding-left:15px;' href='#'><i class='layer-zoom-to glyphicon glyphicon-zoom-in'></i></a>";
            }
            if (layer instanceof ol.layer.Vector && this.showDownload){
                div += "<a title='Descargar Capa' href='#' style='padding-left:15px;'><i class='layer-download glyphicon glyphicon-download-alt'></i></a>";
            }
            if (layer instanceof ol.layer.Vector && this.allowFiltering){
                div += "<a title='Filtrar Capas' href='#' style='padding-left:15px;'><i class='layer-set-filters glyphicon glyphicon-filter'></i></a>";
            }
        }
        if (layer.get("type") != "base" && this.allowReordering && !isInGroup){
            div += "<a title='Subir Capa' href='#' style='padding-left:15px;' href='#'><i class='layer-move-up glyphicon glyphicon-triangle-top'></i></a>";
            div += "<a title='Bajar Capa' href='#' style='padding-left:15px;' href='#'><i class='layer-move-down glyphicon glyphicon-triangle-bottom'></i></a>";
        }
        if (layer.get("isRemovable")){
            div += "<a title='Remover' href='#' style='padding-left:15px;' href='#'><i class='layer-remove glyphicon glyphicon-remove'></i></a>";
        }
