...
showAttributesTable_ = function() {
    ...
    this.createButtons = function() {
        ...
        zoomTo.innerHTML = '<i class="glyphicon glyphicon-search"></i> Zoom a seleccion';
        ...
        clear.innerHTML = '<i class="glyphicon glyphicon-trash"></i> Limpiar Seleccion';
        ...
        tableFilterLabel.innerHTML = " Filtrar:"
        ...
        this.tableFilterBox.setAttribute("placeholder", "Filtre por ...")
        ...
        onlySelected.appendChild(document.createTextNode(" Mostrar solamente los elementos seleccionados"));
...
openChart = function(c){
    ...
    this.drawFromSelection = function(){
        ...
        info.innerHTML = selectedFeatures.length.toString() + " Elementos seleccionados en la Capa " + layerName;
